...
<html>
  <head>
    ...
    <!-- side nav css file -->
    <link
      href="backend/css/SidebarNav.min.css"
      media="all"
      rel="stylesheet"
      type="text/css"
    />
    ...
    <div class="main-content">
            ...
            <div class="navbar-header">
              ...
              <h1>
                <a class="navbar-brand" href="{{url('/home')}}"
                  ><span class="fa fa-film"></span> MotPhim<span
      ...
      <div id="page-wrapper">
        <div class="main-page">
          ...
          <script src="backend/js/serial.js"></script>
          <script src="backend/js/export.min.js"></script>
          <link
            rel="stylesheet"
            href="backend/css/export.css"
            type="text/css"
            media="all"
          />
         
          <script src="backend/js/light.js"></script>
          <!-- for amcharts js -->
      ...
      <div class="footer">
        <p>
          ...
          <a href="" target="_blank">PhungHuyen</a>
        </p>
      </div>
      <!--//footer-->
    </div>
  ...
  <script type="text/javascript">
      $('.select-year').change(function() {
          ...
          $.ajax({
              ...
              success: function() {
                  alert('Thay đổi phim thành năm ' + year + ' thành công');
              }
          });
      })
  </script>
