...
<html lang="vi">
   ...
   <body class="home blog halimthemes halimmovies" data-masonry="">
            ...
            <div class="row" id="headwrap">
               <div class="col-md-3 col-sm-6 slogan">
                  <p class=""><a class="logo" href="" title="phim hay ">
                     <a href="{{route('homepage')}}"> <img src="{{asset('uploads/logo/'.$info->logo)}}" alt=""></a>
                  </a></p>
                  </a>
               </div>
      ...
      <div id="fb-root"></div>
      <script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v15.0" nonce="t96FDfuK"></script>
               ...
               $.getJSON('/json/movie.json', function(data){
                  $.each(data, function(key, value){
                     if(value.title.search(expression) != -1){
                        $('#result').append('<li class="list-group-item" style="cursor:pointer"><img height="30" width="40" src="/uploads/movie/'+value.image+'">'+value.title+'</li>');
                     }
                  });
               })
            }else{
      ...
      {{-- <img src="/uploads/movie/'+value.image+'" height="40" width="40"> --}}
      <div id="fb-root"></div>
      <script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v15.0" nonce="FuEVKNHa"></script>
      <script type="text/javascript">
      $(document).ready(function(){
         $.ajax({
