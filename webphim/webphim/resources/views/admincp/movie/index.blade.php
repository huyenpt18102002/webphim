            ...
            <table class="table" id="tablephim">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  ['class'=>'select-year', 'placeholder' => '--Năm phim--', 'id'=>$cate->id]) !!}
                  </td>
                  <td>
                    {!! Form::select('topview', ['0'=>'Ngày','1'=>'Tuần', '2'=>'Tháng'], isset($cate->topview)? $cate->topview : '', 
                    ['class'=>'select-topview', 'placeholder' => '--Views--', 'id'=>$cate->id]) !!}
                  </td>
                  <td>
                    {!! Form::selectYear('season', 0, 20, isset($cate->season)? $cate->season : '', 
