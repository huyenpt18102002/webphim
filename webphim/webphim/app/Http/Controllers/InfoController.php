    ...
    public function update(Request $request, $id)
    {
        ...
        $data = $request->validate(
            [
                ...
                'image' => 'image|mimes:jpeg,png,jpeg,gif,svg,jfif|max:2048',
            ],
            [
                ...
                'description.max' => 'Mô tả danh mục chỉ dài tối đa 555 kí tự.',
                'copyright.required' => 'Copyright bắt buộc phải nhập.',
            ]
        );
        $info = Info::find($id);
        ...
        $info->save();
        toastr()->success('Success', 'Cập nhật thông tin web thành công.');
